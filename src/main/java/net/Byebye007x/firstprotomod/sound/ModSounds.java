package net.Byebye007x.firstprotomod.sound;
...
public class ModSounds {
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS =
            DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, ProtoMod.MOD_ID);

    public static final RegistryObject<SoundEvent> CUSTOM_SWORD_SWING = registerSoundEvents("custom_sword_swing");
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(ProtoMod.MOD_ID, name)));
    }
